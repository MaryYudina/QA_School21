...
Резюме: в этом проекте ты познакомишься с основами работы QA-инженера по ручному тестированию. 
